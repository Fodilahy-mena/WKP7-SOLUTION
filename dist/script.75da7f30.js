...
var showBooks = function showBooks() {
  var html = books.map(function (book) {
    return "\n        <tr>\n            <td class=\"left\">".concat(book.title, "</td>\n            <td>").concat(book.author, "</td>\n            <td>").concat(book.genre, "</td>\n            <td>").concat(book.pages, "</td>\n            <td>\n                <button\n                value=\"").concat(book.id, "\"\n                class=\"check\"\n                area-label=\"Update read attribute of ").concat(book.title, "\">\n                    <img ").concat(book.read ? '' : 'hidden', "\n                    src=\"./assets/icons/checked.svg\"\n                    alt=\"the book ").concat(book.title, " is read\"/>\n\n                    <img ").concat(book.read ? 'hidden' : '', "\n                    src=\"./assets/icons/unchecked.svg\"\n                    alt=\"the book ").concat(book.title, " is not yet read\"/>\n                </button>\n            </td>\n            <td>\n                <button\n                value=\"").concat(book.id, "\" \n                class=\"delete\"\n                area-label=\"Delete ").concat(book.title, " book\">\n                    <img \n                    src=\"./assets/icons/trash.svg\" \n                    alt=\"Delete ").concat(book.title, " fron the list\"/>\n                </button>\n            </td>\n        </tr>\n        ");
  }).join('');
...
var handleClick = function handleClick(e) {
  console.log(e.target); // Update read attribute

  var checkBtn = e.target.closest('button.check');
  ...
  if (deleteBtn) {
    var _id = Number(deleteBook.value);
...
var deleteBook = function deleteBook(idToDelete) {
...
var updateRead = function updateRead(id) {
  var bookToUpdate = books.find(function (book) {
    return book.id === id;
  });
  console.log(bookToUpdate); // objects and arrays are passed by reference (and not by a value)

  bookToUpdate.read = !bookToUpdate.read;
  console.log(books); // if we just update the attribute here, it will be also ipdated to the books 
